...
<body>
	<div id="wrap">
		...
		<article>
			<h1>게시판 답글쓰기</h1>
			<!-- 전달정보 있음 bno, pageNum, re_ref, re_lev, re_seq -->
			...
			<table id="notice">
				<tr>
					<th colspan = "2" class="ttitle">게시판 답글쓰기(Re_Create)</th>
				</tr>
				<tr>
					<td class="left">글쓴이</td><td class="left"><input type="text" name="name"></td>
				</tr>
				<tr>
					<td class="left">제목</td><td class="left">
					<input type="text" name="subject" value="[답글]"></td>
				</tr>
				<tr>
					<td class="left">내용</td>
